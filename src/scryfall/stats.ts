...
export const ScryfallStatsSchema = z.object({
  ...
  toughness: z.string().nullish().describe("This card's toughness, if any"),
  loyalty: z.string().nullish().describe("This card's loyalty, if any"),
  defense: z.string().nullish().describe("This card's defense, if any"),
});
